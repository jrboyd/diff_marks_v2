                    ...
                    tabsetPanel(type = 'pills',
                                ...
                                tabPanel("Plot Appearance",
                                         tags$div(title="How much of the interface should the Selection Plot take up.",
                                                  sliderInput('selection_plot_size', label = 'Selection Plot Size', min = 3, max = 8, value = 3, step = .5)),
                                ...
                                tabPanel("Highlight/Select",
                                         ...
                                         actionButton("highlight_sel", "Highlight Selected"),
                                         actionButton("sel_highlight", "Select Highlighted"),
                                         actionButton("remove_highlight", "Remove Highlighting")
                                ),
                                tabPanel("Download",
